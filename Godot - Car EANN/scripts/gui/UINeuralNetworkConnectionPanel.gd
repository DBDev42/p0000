...
# References to be set in editor.
#export var connections : Image[] = []
export var connections = []
#export var positive_color : Color("#ff00ff00")
export var positive_color = Color("#ff00ff00")
#export var negative_color : Color("#ff00ff00")
export var negative_color = Color("#ffff0000")

# Displays the connections of a neuron of one layer to all neurons of the next layer.
#func display_connections(neuron_index : int, current_layer : NeuralLayer, next_layer : UINeuralNetworLayerPanel) -> void :
func display_connections(neuron_index, current_layer, next_layer) :
